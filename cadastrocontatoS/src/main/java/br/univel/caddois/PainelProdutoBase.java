...
public class PainelProdutoBase extends JPanel {
	...
	public PainelProdutoBase() {
		...
		GridBagConstraints gbc_txfValor = new GridBagConstraints();
		gbc_txfValor.gridwidth = 2;
		gbc_txfValor.insets = new Insets(0, 0, 0, 5);
		gbc_txfValor.anchor = GridBagConstraints.WEST;
		gbc_txfValor.gridx = 1;
		gbc_txfValor.gridy = 2;
		panel.add(txfValor, gbc_txfValor);
